...
I suggest you to provision resources starting with a combination of Az module and Az CLI (giving priority to the first) and left ARM templates as last resort. I hope that sharing my experiences with Azure RM could help you save a nice amount of time. _So, it's time to sculpt some cloud!_
